...
import 'package:split_smart/models/friendDivBarValues.dart';


class FDivisionBarClass extends StatefulWidget {
  @override
  _FDivisionBarClassState createState() => _FDivisionBarClassState();
}

class _FDivisionBarClassState extends State<FDivisionBarClass> {
  FriendDivBarValuesClass _valuesClass = new FriendDivBarValuesClass();
